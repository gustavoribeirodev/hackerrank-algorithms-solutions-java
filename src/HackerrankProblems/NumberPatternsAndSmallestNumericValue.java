...
Each character (M or N) needs to display sequence of numbers(2 numbers) explaining the ascending or descending order
(for ex: 21 ->represents descending -> M) .
The second character in the pattern takes the last digit from first character and builds the sequence and so on.
Please look at example section below.
...
public class NumberPatterns01 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // verifica se o arquivo esta nulo ou vazio
        if (fileName != null) {
